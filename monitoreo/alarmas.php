     	...
     	<div class="container">
     		<div class="col-xs-12">
     			...
     			<div class="col-xs-12 col-md-4 opciones">
     				<ul class="col-xs-12">
     					<li class="col-xs-6">
     						<a class="btn btn-info" href="Alarmas/Alarmas_formulario.php">
     				...
     				<tbody>
     					...
     					?>
     							<tr>
     								...
     								<td class="text-center">
     									<a href="Alarmas/Alarmas_formulario.php?id=<?php echo $row['id'] ?>" class="btn btn-primary btn-sm">
     										Editar
     									</a>
                      <a href="Alarmas/Alarmas_eliminar.php?id=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm">
                        Eliminar
                      </a>
     								</td>
     							</tr>
